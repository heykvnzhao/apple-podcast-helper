const { DEFAULT_LIST_LIMIT, DEFAULT_SELECT_PAGE_SIZE } = require("../app-constants")
...
function parseSyncOptions(args) {
	...
	if (positional.length === 1) {
		options.errors.push("sync command requires both input.ttml and output.md when using positional arguments")
		return options
	}
